...
private Q_SLOTS:
    ...
    void test_impulse()
    {
        ...
        auto testImpulseExprC = make_expression_atom(
                    Impulse(), expression_atom::Comparator::EQUAL, true);
