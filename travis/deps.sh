...
case "$TRAVIS_OS_NAME" in
  linux)
    ...
    sudo apt-get update -qq
    sudo apt-get install -qq --yes --force-yes g++-6 binutils ninja-build gcovr lcov qt59-meta-minimal libasound2-dev clang-4.0 lld-4.0 gcc-6-arm-linux-gnueabihf g++-6-arm-linux-gnueabihf
