...
if ( $env:APPVEYOR_BUILD_TYPE -eq "testing" ){
  ...
  cmake -G "Visual Studio 15 2017 Win64" -DCMAKE_INSTALL_PREFIX="${env:APPVEYOR_BUILD_FOLDER}/install" -DCMAKE_BUILD_TYPE=Release -DOSSIA_PD=0 -DOSSIA_CI=1 -DOSSIA_C=1 -DOSSIA_CPP=1 -DOSSIA_UNITY3D=1 -DOSSIA_TESTING=0 -DBOOST_ROOT="${env:BOOST_ROOT}" -DCMAKE_PREFIX_PATH="${env:QTDIR}\lib\cmake\Qt5" c:\projects\libossia > $LogFile
  CheckLastExitCode
  ...
  cmake -G "Visual Studio 15 2017"       -DCMAKE_INSTALL_PREFIX="${env:APPVEYOR_BUILD_FOLDER}/install-32bit" -DCMAKE_BUILD_TYPE=Release -DOSSIA_PD=0 -DOSSIA_CI=1 -DOSSIA_C=1 -DOSSIA_CPP=1 -DOSSIA_UNITY3D=1 -DOSSIA_TESTING=0 -DBOOST_ROOT="${env:BOOST_ROOT}" -DCMAKE_PREFIX_PATH="${env:QTDIR-32bit}\lib\cmake\Qt5" c:\projects\libossia > $LogFile
  CheckLastExitCode
  ...
  cmake -G "Visual Studio 15 2017" -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX="${env:APPVEYOR_BUILD_FOLDER}/install" -DOSSIA_STATIC=1 -DOSSIA_PD=1 -DOSSIA_QT=0 -DOSSIA_PROTOCOL_MIDI=OFF -DOSSIA_EXAMPLES=0 -DOSSIA_CI=1 -DOSSIA_TESTING=0 -DOSSIA_PYTHON=0 -DOSSIA_QML=0 -DBOOST_ROOT="${env:BOOST_ROOT}" -DOSSIA_EDITOR=OFF -DOSSIA_DATAFLOW=OFF c:\projects\libossia > $LogFile
  CheckLastExitCode
  ...
  $LogFile = "c:\projects\libossia\configure-pd.log"
  cmake -G "Visual Studio 15 2017" -DCMAKE_BUILD_TYPE=Debug -DCMAKE_INSTALL_PREFIX="${env:APPVEYOR_BUILD_FOLDER}/install" -DCMAKE_PREFIX_PATH="${env:QTDIR-32bit}\lib\cmake\Qt5" -DOSSIA_STATIC=1 -DOSSIA_PD=1 -DOSSIA_QT=0 -DOSSIA_PROTOCOL_MIDI=OFF -DOSSIA_EXAMPLES=0 -DOSSIA_CI=1 -DOSSIA_TESTING=1 -DOSSIA_PYTHON=0 -DOSSIA_QML=0 -DBOOST_ROOT="${env:BOOST_ROOT}" -DOSSIA_EDITOR=OFF -DOSSIA_DATAFLOW=OFF c:\projects\libossia > $LogFile
  CheckLastExitCode
  ...
  cmake -G "Visual Studio 15 2017 Win64" -DCMAKE_BUILD_TYPE=Release -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX="${env:APPVEYOR_BUILD_FOLDER}/install" -DCMAKE_PREFIX_PATH="${env:QTDIR}\lib\cmake\Qt5"  -DOSSIA_STATIC=0 -DOSSIA_PD=0 -DOSSIA_QT=1 -DOSSIA_EXAMPLES=0 -DOSSIA_CI=1 -DOSSIA_TESTING=0 -DOSSIA_PYTHON=0 -DOSSIA_QML=1 -DBOOST_ROOT="${env:BOOST_ROOT}" -DOSSIA_EDITOR=ON -DOSSIA_DATAFLOW=OFF c:\projects\libossia > $LogFile
  CheckLastExitCode
}
