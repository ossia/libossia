...
if ( $env:APPVEYOR_BUILD_TYPE -eq "testing" ){
  ...
  make -v
  bash -lc "make -v"
  bash -lc "export PATH=/c/msys64/MINGW64/bin:/c/msys64/usr/bin:$PATH ; cd  C:/projects/libossia/install/ossia-pd-package/ ; chmod 755 deken ; ./deken upload -v test ossia"
