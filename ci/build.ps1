...
if ( $env:APPVEYOR_BUILD_TYPE -eq "max" -Or $env:APPVEYOR_BUILD_TYPE -eq "Release" -Or $env:APPVEYOR_BUILD_TYPE -eq "ossia-cpp" -Or $env:APPVEYOR_BUILD_TYPE -eq "ossia-unity3d"){
...
if ( $env:APPVEYOR_BUILD_TYPE -eq "Release" -Or $env:APPVEYOR_BUILD_TYPE -eq "ossia-cpp" -Or $env:APPVEYOR_BUILD_TYPE -eq "ossia-unity3d"){
  cd C:\projects\libossia\build\
