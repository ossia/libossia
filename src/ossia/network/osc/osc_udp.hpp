...
class OSSIA_EXPORT osc_udp_protocol
...
class OSSIA_EXPORT osc_udp_server final
    : public osc_udp_protocol
{
public:
  using osc_udp_protocol::osc_udp_protocol;
...
class OSSIA_EXPORT osc_udp_client final
    : public osc_udp_protocol
{
public:
  using osc_udp_protocol::osc_udp_protocol;
