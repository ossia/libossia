...
#include <type_traits>
#include <cassert>
// Taken from https://www.reddit.com/r/cpp/comments/4yp7fv/c17_structured_bindings_convert_struct_to_a_tuple/
...
auto to_tuple(T&& object) noexcept {
    return detail::to_tuple_impl(std::forward<T>(object), detail::to_tuple_size<std::decay_t<T>>{});
}
}
