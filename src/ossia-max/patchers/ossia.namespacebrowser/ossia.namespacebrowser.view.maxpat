...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 285.0, 105.0, 151.0, 22.0 ],
					"text" : "ossia.remote local_receive"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 285.0, 150.0, 82.0, 22.0 ],
					"text" : "prepend send"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 780.0, 255.0, 60.0, 20.0 ],
					"text" : "delete?"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 60.0, 42.0, 22.0 ],
					"text" : "t b b 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 675.0, 30.0, 172.0, 22.0 ],
					"text" : "ossia.view #1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 795.0, 195.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 795.0, 165.0, 36.0, 22.0 ],
					"text" : "sel 9"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 675.0, 255.0, 105.0, 22.0 ],
					"text" : "t l l",
					"textcolor" : [ 0.968627450980392, 0.968627450980392, 0.968627450980392, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 675.0, 165.0, 61.0, 22.0 ],
					"text" : "route text"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 675.0, 105.0, 163.0, 42.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 345.0, 89.0, 22.0 ],
					"text" : "vexpr $i1 + $i2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 240.0, 156.0, 22.0 ],
...
, 			{
				"box" : 				{
					"align" : 0,
					"annotation" : "Browse ossia namespace",
					"bgcolor" : [ 0.7, 0.7, 0.7, 1.0 ],
					"bgoncolor" : [ 0.55, 0.55, 0.55, 1.0 ],
					"fontsize" : 18.0,
					"hint" : "Browse ossia namespace",
					"id" : "obj-33",
					"legacytextcolor" : 1,
					"maxclass" : "textbutton",
					"numinlets" : 1,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 294.5, 183.0, 264.5, 183.0 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 735.5, 242.0, 684.5, 242.0 ],
					"source" : [ "obj-17", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 360.5, 138.0, 294.5, 138.0 ],
					"source" : [ "obj-18", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 770.5, 345.0, 684.5, 345.0 ],
					"source" : [ "obj-22", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 684.5, 392.0, 643.5, 392.0, 643.5, 94.0, 684.5, 94.0 ],
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 0 ],
					"midpoints" : [ 51.0, 108.0, 264.5, 108.0 ],
					"source" : [ "obj-9", 1 ]
				}
