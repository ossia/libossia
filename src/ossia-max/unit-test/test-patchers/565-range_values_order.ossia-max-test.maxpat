...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 294.0, 62.0, 275.0, 22.0 ],
					"text" : "ossia.test-logger \"Range value order\" @autoquit 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 566.0, 344.0, 154.0, 22.0 ],
					"text" : "ossia.assert \"Range Order\""
				}
