...
if(OSSIA_DATAFLOW)
  ...
  find_package(SDL2 CONFIG)
  if(TARGET SDL2::SDL2-static)
    message("ossia_features.cmake:279")
    target_link_libraries(ossia PRIVATE SDL2::SDL2-static)
  elseif(TARGET SDL2::SDL2)
    message("ossia_features.cmake:282")
    target_link_libraries(ossia PRIVATE SDL2::SDL2)
  else()
    # Used for audio support in emscripten
    find_package(SDL)
    if(SDL_FOUND)
      message("ossia_features.cmake:288")
