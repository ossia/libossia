...
public:
  void state(
      ossia::time_value date, double pos, ossia::time_value tick_offset,
      double gspeed) override;
...
public:
  ...
  void scriptChanged(QQmlScriptString arg_1)
      E_SIGNAL(OSSIA_EXPORT, scriptChanged, arg_1);
