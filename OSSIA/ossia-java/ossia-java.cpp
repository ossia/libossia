...
auto safe_function(std::string name, jni::JNIEnv& env, Fun f) -> decltype(f())
{
  try
  {
    return f();
...
public:
  ...
  jni::jlong GetType(jni::JNIEnv& e)
  {
    return {};
  }
};
...
struct Calculator
{
  ...
  jni::jlong Add(jni::JNIEnv&, jni::jlong a, jni::jlong b)
  {
    return a + b;
  }
...
extern "C" JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void*)
{
  ...
  jni::RegisterNativePeer<Value>(
      env, jni::Class<Value>::Find(env), "peer",
      std::make_unique<Value, JNIEnv&>, "initialize", "finalize",
      METHOD(&Value::SetInt, "setInt"), METHOD(&Value::SetFloat, "setFloat"),
      METHOD(&Value::SetBool, "setBool"), METHOD(&Value::SetChar, "setChar"),
      ...
      */
      ...
      METHOD(&Value::GetInt, "getInt"), METHOD(&Value::GetFloat, "getFloat"),
      METHOD(&Value::GetBool, "getBool"), METHOD(&Value::GetChar, "getChar"),
