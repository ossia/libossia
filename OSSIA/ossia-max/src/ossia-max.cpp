...
template bool max_object_register<parameter>(parameter*);
template bool max_object_register<model>(model*);
template bool max_object_register<remote>(remote*);
template bool max_object_register<view>(view*);
