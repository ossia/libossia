...
void ossia_logger_setup()
{
    ...
    ossia_library.ossia_logger_class = class_new("ossia.logger",
                                                 (method) ossia_logger_new,
                                                 (method) ossia_logger_free,
                                                 (long) sizeof(t_logger),
                                                 0L, A_GIMME, 0);
    
    class_addmethod(ossia_library.ossia_logger_class, (method) ossia_logger_in_anything,         "anything",     A_GIMME, 0);
...
extern "C"
void ossia_logger_in_anything(t_logger* x,
...
extern "C"
void ossia_logger_free(t_logger* x)
{
  if (x)
  {
    x->m_log.reset();
