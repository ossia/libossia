...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 606.0, 237.0, 186.0, 64.0 ],
									"style" : "",
									"text" : "Click 'namespace' message to get all patcher's nodes addresse",
...
,
									"patching_rect" : [ 485.0, 290.0, 106.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 485.0, 258.0, 73.0, 22.0 ],
									"style" : "",
									"text" : "namespace"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 46.0, 228.0, 202.0, 22.0 ],
													"style" : "",
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 46.0, 192.0, 168.0, 22.0 ],
													"style" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 648.0, 292.0, 186.0, 64.0 ],
									"style" : "",
									"text" : "Click 'namespace' message to get all patcher's nodes addresse",
									"textcolor" : [ 0.3, 0.3, 0.3, 1.0 ]
								}
...
,
									"patching_rect" : [ 527.0, 345.0, 106.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 527.0, 313.0, 73.0, 22.0 ],
									"style" : "",
									"text" : "namespace"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "list", "", "", "" ],
									"patching_rect" : [ 527.0, 380.0, 324.0, 288.0 ]
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 9.0, 106.0, 266.0, 22.0 ],
													"style" : "",
													"text" : "ossia.parameter another_parameter @type bool"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 9.0, 77.0, 231.0, 22.0 ],
													"style" : "",
													"text" : "ossia.parameter my_parameter @type int"
												}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 103.0, 435.0, 266.0, 22.0 ],
									"style" : "",
									"text" : "ossia.parameter another_parameter @type bool"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 103.0, 406.0, 231.0, 22.0 ],
									"style" : "",
									"text" : "ossia.parameter my_parameter @type int"
								}
