...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 72.0, 249.0, 340.0, 22.0 ],
					"style" : "",
					"text" : "ossia.parameter my_string @type string @access_mode GET"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 72.0, 206.0, 346.0, 22.0 ],
					"style" : "",
					"text" : "ossia.parameter my_boolean @type bool @access_mode SET"
				}
