...
using orientation_u_list =
brigand::list<
quaternion_u, euler_u, axis_u>;

using position_u_list =
...
template<> struct matching_unit_u_list<color_u> { using type = color_u_list; };
template<> struct matching_unit_u_list<distance_u> { using type = distance_u_list; };
template<> struct matching_unit_u_list<position_u> { using type = position_u_list; };
...
template<> struct matching_unit_u_list<distance_u_list> { using type = distance_u; };
template<> struct matching_unit_u_list<position_u_list> { using type = position_u; };
...
using position_list =
brigand::list<cartesian_3d, cartesian_2d, spherical, polar, opengl, cylindrical>;
...
template<> struct matching_unit_list<color> { using type = color_list; };
template<> struct matching_unit_list<distance> { using type = distance_list; };
template<> struct matching_unit_list<position> { using type = position_list; };
...
template<> struct matching_unit_list<distance_list> { using type = distance; };
template<> struct matching_unit_list<position_list> { using type = position; };
...
struct unit_factory_visitor
{
  ...
  {
    static const auto units = brigand::wrap<typename matching_unit_u_list<Dataspace_T>::type, make_unit_map>{}();
