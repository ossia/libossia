...
{
// COLOR //
strong_value<hsv_u::neutral_unit> hsv_u::to_neutral(strong_value<hsv_u::concrete_type> self)
{
...
strong_value<xyz_u::neutral_unit> xyz_u::to_neutral(strong_value<xyz_u::concrete_type> self)
{
...
strong_value<axis_u::neutral_unit> axis_u::to_neutral(strong_value<axis_u::concrete_type> self)
{
  const auto x = self.dataspace_value[0];
  const auto y = self.dataspace_value[1];
  const auto z = self.dataspace_value[2];
...
strong_value<spherical_u::neutral_unit> spherical_u::to_neutral(strong_value<spherical_u::concrete_type> self)
{
...
spherical_u::value_type spherical_u::from_neutral(strong_value<spherical_u::neutral_unit> self)
{
  const auto x = self.dataspace_value[0];
  const auto y = self.dataspace_value[1];
  const auto z = self.dataspace_value[2];
...
strong_value<cylindrical_u::neutral_unit> cylindrical_u::to_neutral(strong_value<cylindrical_u::concrete_type> self)
{
...
cylindrical_u::value_type cylindrical_u::from_neutral(strong_value<cylindrical_u::neutral_unit> self)
{
  const auto x = self.dataspace_value[0];
  const auto y = self.dataspace_value[1];
  const auto z = self.dataspace_value[2];
