...
namespace net {
    ...
    void wiimote_protocol::set_device(ossia::net::device_base& dev)
    {
        ...
        m_event_thread =
            std::thread(wiimote_event_loop, this);
    }
    ...
    void wiimote_protocol::create_wiimote_parameters(const unsigned int wiimote_id)
    {
        ...
        //  Buttons parameters
        parameters.
            button_parameters[WIIMOTE_BUTTON_ONE] = 
        ...
        parameters.                
            button_parameters[WIIMOTE_BUTTON_TWO] = 
                device_parameter::create_device_parameter(
                    root, path + "button-2",  
                    false, val_type::BOOL, 
                    bounding_mode::FREE, 
        ...
        parameters.        
            button_parameters[WIIMOTE_BUTTON_A] = 
                device_parameter::create_device_parameter(
                    root, path + "button-A", 
                    false, val_type::BOOL, 
                    bounding_mode::FREE, 
        ...
        parameters.
            button_parameters[WIIMOTE_BUTTON_B] = 
                device_parameter::create_device_parameter(
                    root, path + "button-B", 
                    false, val_type::BOOL, 
                    bounding_mode::FREE, 
        ...
        parameters.
            button_parameters[WIIMOTE_BUTTON_MINUS] = 
                device_parameter::create_device_parameter(
                    root, path + "button-minus", 
                    false, val_type::BOOL, 
                    bounding_mode::FREE, 
                    access_mode::GET, 
                    init_domain(val_type::BOOL));
        ...
        parameters.
            button_parameters[WIIMOTE_BUTTON_PLUS] = 
                device_parameter::create_device_parameter(
                    root, path + "button-plus", 
                    false, val_type::BOOL, 
                    bounding_mode::FREE, 
                    access_mode::GET, 
                    init_domain(val_type::BOOL));
        ...
        parameters.
            button_parameters[WIIMOTE_BUTTON_HOME] = 
                device_parameter::create_device_parameter(
                    root, path + "button-home", 
                    false, val_type::BOOL, 
                    bounding_mode::FREE, 
                    access_mode::GET, 
                    init_domain(val_type::BOOL));
        ...
        parameters.
            button_parameters[WIIMOTE_BUTTON_LEFT] = 
                device_parameter::create_device_parameter(
                    root, path + "button-left", 
                    false, val_type::BOOL, 
                        bounding_mode::FREE,
                        access_mode::GET,
                        init_domain(val_type::BOOL));
        ...
        parameters.
            button_parameters[WIIMOTE_BUTTON_RIGHT] =
                device_parameter::create_device_parameter(
                        root, path + "button-right",
                        false, val_type::BOOL,
                        bounding_mode::FREE,
                        access_mode::GET,
                        init_domain(val_type::BOOL));
        ...
        parameters.
            button_parameters[WIIMOTE_BUTTON_DOWN] =
                device_parameter::create_device_parameter(
                        root, path + "button-down",
                        false, val_type::BOOL,
                        bounding_mode::FREE,
                        access_mode::GET,
                        init_domain(val_type::BOOL));
        ...
        parameters.
            button_parameters[WIIMOTE_BUTTON_UP] = 
                device_parameter::create_device_parameter(
                    root, path + "button-up", 
                    false, val_type::BOOL, 
                    bounding_mode::FREE, 
        ...
        for (unsigned int i = 0; i < 4; i++)
            device_parameter::create_device_parameter<led_parameter>(
                root, path + "led-" + std::to_string(i), 
                false, m_wiimotes[wiimote_id], i);
    ...
    void wiimote_protocol::wiimote_event_loop(wiimote_protocol *self)
    {
        ...
        while (self->m_running) {
            ...
            const int ret =
                wiiuse_poll(self->m_wiimotes, wiimote_count);
    ...
    {
        wiimote_parameters& parameters = 
            self->m_wiimotes_parameters[wiimote_id];

        wiimote_t *wiimote = 
            self->m_wiimotes[wiimote_id];
       ...
       // Update wiimote axis
        ...
        if (self->m_wiimotes[wiimote_id]->exp.type == EXP_NUNCHUK) {
            ...
            parameters.nunchuk_joystick->
                push_value(
                    std::array<float, 2>{
                        nunchuk->js.x,
                        nunchuk->js.y});

            parameters.nunchuk_button_c->
                push_value(
                    IS_PRESSED(nunchuk, NUNCHUK_BUTTON_C));

            parameters.nunchuk_button_z->
                push_value(
