...
struct unit_parser
{
  ossia::fast_hash_map<ossia::small_vector<std::string, 4>, ossia::unit_t> map
  {
    ...
    // { { "color.rgb.r", "color.rgb.g", "color.rgb.b" }, ossia::rgba8_u{} }, // not needed
    { { "color.rgb.r", "color.rgb.g", "color.rgb.b" }, ossia::rgb_u{} },
    { { "color.rgb.b", "color.rgb.g", "color.rgb.r" }, ossia::bgr_u{} },
    { { "color.rgb8.a", "color.rgb8.r", "color.rgb8.g", "color.rgb8.b" }, ossia::argb8_u{} },
    ...
    { { "color.cmyk8.c", "color.cmyk8.m", "color.cmyk8.y", "color.cmyk8.k" }, ossia::cmyk8_u{} },
    { { "color.cieYxy.y", "color.cieYxy.x", "color.cieYxy.y" }, ossia::yxy_u{} },
    { { "color.hunterLab.l", "color.hunterLab.a", "color.hunterLab.b" }, ossia::hunter_lab_u{} },
    ...
    { { "position.cartesian.x", "position.cartesian.y", "position.cartesian.z" }, ossia::cartesian_3d_u{} },
  ...
  template<typename T>
  static std::pair<ossia::small_vector<std::string, 4>, ossia::unit_t> unit_matcher(const T&)
  {
