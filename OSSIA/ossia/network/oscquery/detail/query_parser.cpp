...
void query_parser::parse(net::access_mode_attribute, const std::string& data, net::address_data& res) {
  try {
...
void query_parser::parse(net::bounding_mode_attribute, const std::string& data, net::address_data& res)
{
  if(data.size() > 2)
  {
...
void query_parser::parse(net::repetition_filter_attribute, const std::string& data, net::address_data& res)
{
  try {
...
void query_parser::parse(net::refresh_rate_attribute attr, const std::string& data, net::address_data& res)
{
  try {
...
void query_parser::parse(net::priority_attribute attr, const std::string& data, net::address_data& res)
{
  try {
    using type = decltype(attr)::type;
    auto i = boost::lexical_cast<type>(data);
...
void query_parser::parse(net::value_step_size_attribute attr, const std::string& data, net::address_data& res)
{
  try {
    using type = decltype(attr)::type;
    auto i = boost::lexical_cast<type>(data);
...
void query_parser::parse(net::critical_attribute attr, const std::string& data, net::address_data& res)
{
  try {
    bool b = parse_bool(data);
    attr.setter(res, b);
...
void query_parser::parse(net::description_attribute attr, const std::string& data, net::address_data& res)
{
  attr.setter(res, data);
}

void query_parser::parse(net::app_name_attribute attr, const std::string& data, net::address_data& res)
{
  attr.setter(res, data);
}

void query_parser::parse(net::app_version_attribute attr, const std::string& data, net::address_data& res)
{
  attr.setter(res, data);
}

void query_parser::parse(net::app_creator_attribute attr, const std::string& data, net::address_data& res)
{
  attr.setter(res, data);
}
...
void query_parser::parse(net::extended_type_attribute attr, const std::string& data, net::address_data& res)
{
  attr.setter(res, data);
}
