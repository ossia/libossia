  ...
  const char* phidget_name(Phidget_ChannelClass cls)
  {
    switch (cls)
    {
      ...
      case PHIDCHCLASS_MOTORPOSITIONCONTROLLER:
        return "MOTORPOSITIONCONTROLLER";
...
{
  return lhs.serialNumber == rhs.serialNumber && lhs.hubPort == rhs.hubPort
         && lhs.channel == rhs.channel && lhs.isHubPort == rhs.isHubPort;
}
}
