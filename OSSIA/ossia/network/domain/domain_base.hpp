...
struct OSSIA_EXPORT domain
{
  ...
  domain& operator=(const domain& d) { v = d.v; return *this; }
  domain& operator=(domain&& d) { v = std::move(d.v); return *this; }
...
auto apply(Functor&& functor, const domain& var)
  -> decltype(auto)
{
  return ossia::apply(std::forward<Functor>(functor), var.v);
}
template<typename Functor>
auto apply(Functor&& functor, domain& var)
  -> decltype(auto)
{
  return ossia::apply(std::forward<Functor>(functor), var.v);
}
...
template<typename Functor>
auto apply_nonnull(Functor&& functor, const domain& var)
  -> decltype(auto)
{
  return ossia::apply_nonnull(std::forward<Functor>(functor), var.v);
}
template<typename Functor>
auto apply_nonnull(Functor&& functor, domain& var)
  -> decltype(auto)
{
  return ossia::apply_nonnull(std::forward<Functor>(functor), var.v);
}
