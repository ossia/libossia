...
namespace net
{
osc_protocol::osc_protocol(std::string ip, uint16_t remote_port, uint16_t local_port) :
    mIp{ip},
...
osc_protocol& osc_protocol::setLearningStatus(ossia::net::device_base& ossiaDevice, bool newLearn)
{
    return *this;
}
