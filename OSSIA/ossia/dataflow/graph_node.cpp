...
bool graph_node::enabled() const { return m_enabled; }

void graph_node::set_enabled(bool b) { m_enabled = b; }

bool graph_node::executed() const { return m_executed; }

void graph_node::set_executed(bool b) { m_executed = b; }
...
const inlets& graph_node::inputs() const { return m_inlets; }
