...
struct ws_generic_client_address_data_base
{
  ...
  ws_generic_client_address_data_base(
      const ws_generic_client_address_data_base&)
      = default;
  ws_generic_client_address_data_base(ws_generic_client_address_data_base&&)
      = default;
  ws_generic_client_address_data_base&
  operator=(const ws_generic_client_address_data_base&)
      = default;
  ws_generic_client_address_data_base&
  operator=(ws_generic_client_address_data_base&&)
      = default;
      ...
      public ws_generic_client_address_data_base
{
  ...
  ws_generic_client_address_data(const ws_generic_client_address_data&)
      = default;
  ws_generic_client_address_data(ws_generic_client_address_data&&) = default;
  ws_generic_client_address_data&
  operator=(const ws_generic_client_address_data&)
      = default;
  ws_generic_client_address_data& operator=(ws_generic_client_address_data&&)
      = default;

  ws_generic_client_address_data(const std::string& name) : address_data{name}
  {
  }
