...
qml_property_context::qml_property_context(
    QQmlProperty& p,
    net::address_base& addr,
    QObject* parent):
  QObject{parent},
  targetProperty{p}, address{addr}
{
...
qml_property_writer::qml_property_writer(QQuickItem *parent)
  : qml_node_base(parent)
{
  connect(this, &qml_property_writer::setValue_sig,
          this, &qml_property_writer::setValue_slot,
          Qt::QueuedConnection);
...
qml_callback::qml_callback(QQuickItem *parent)
  : qml_node_base(parent)
{
  connect(this, &qml_callback::setValue_sig,
          this, &qml_callback::setValue_slot,
          Qt::QueuedConnection);
