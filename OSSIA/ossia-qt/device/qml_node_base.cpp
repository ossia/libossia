...
qml_node_base::qml_node_base(QQuickItem* parent) : QQuickItem{parent}
{
}
...
net::node_base* qml_node_base::ossiaNode()
{
  return m_ossia_node;
}
...
ossia::net::node_base&
qml_node_base::findClosestParent(QObject* obj, ossia::net::node_base& root)
{
  if (obj)
  {
