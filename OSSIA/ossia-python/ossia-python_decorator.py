...
for each instance of the class : it creates an Ossia::Node under a given Ossia:Node.
for each @property of the class : it creates an Ossia:Node with an Ossia::Address with bidirectional acces mode on the value 
for each method of the class : it creates an Ossia:Node with an Ossia::Address with set only acces mode on the value 
for each @property with no @setter decorator : it creates an Ossia:Node with an Ossia::Address with get only acces mode on the value  
