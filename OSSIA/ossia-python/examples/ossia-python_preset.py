...
print("Save preset")
ossia.save_preset(local_device.root_node, "preset.json", "MyPreset")

# change parameter values
print("Load preset")
ossia.load_preset(local_device.root_node, "preset2.json")

print("Iterate again to see the changes")
iterate_on_children(local_device.root_node)
