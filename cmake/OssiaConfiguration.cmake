...
# The standard and /Zc:__cplusplus are set in OssiaCxxStandard, before the
# dependencies. These are ours alone.
if(MSVC)
  set(CMAKE_CXX_FLAGS " /EHsc /MP /permissive- /volatile:iso ${CMAKE_CXX_FLAGS} ")
endif()
