...
TEST_CASE("test_comm_osc_tcp_cobs_server_client", "test_comm_osc_tcp_cobs_server_client")
{
...
TEST_CASE("test_comm_osc_tcp_cobs_client_server", "test_comm_osc_tcp_cobs_client_server")
{
  using namespace ossia::net;
...
TEST_CASE("test_comm_osc_tcp_cobs_big", "test_comm_osc_tcp_cobs_big")
{
  using namespace ossia::net;
...
TEST_CASE("test_comm_osc_tcp_cobs", "test_comm_osc_tcp_cobs")
{
  using namespace ossia::net;
